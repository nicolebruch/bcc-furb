...
public class Uni4Exe24Variacao2 {
    ...
    private static void ordemCrescente(int numero1, int numero2, int numero3) {
        int[] numeros = ordenar(numero1, numero2, numero3);
    ...
    /*
     * cria a lista pros métodos voids validarem e ordenarem conforme precisa,
     * sendo crescente, decrescente, maior no meio
     */
    private static int[] ordenar(int numero1, int numero2, int numero3) {
        var numeros = new int[] { numero1, numero2, numero3 };
        if (numero1 > numero2) {
            numeros = ordenar(numero2, numero1, numero3);
        }
        if (numero1 > numero3) {
            numeros = ordenar(numero3, numero2, numero1);
        }
        if (numero2 > numero3) {
            numeros = ordenar(numero1, numero3, numero2);
        }
        return numeros;
    }
}
